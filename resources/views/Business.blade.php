...
@section('content')
    ...
    <div class="lg:m-4 lg:flex mb-4">
        ...
        <div class="lg:w-1/3 w-11/12 h-max lg:h-64 border border-gray-300 rounded-lg p-4 m-4 bg-blue-900">
            <div class="lg:relative lg:top-1/5">
    ...
    <div class="lg:m-4 lg:flex mb-4 lg:w-2/3">
        <div class="lg:w-1/2 w-11/12 h-max border border-gray-300 rounded-lg p-4 m-4 bg-blue-900">
            <div class="lg:relative lg:top-1/4">
                <a class="underline underline-offset-8 text-2xl text-white"  href="https://www.tidio.com/">Tidio</a>
                <p class="mt-4 text-right font-cairo text-xl text-white"> يقدم هذا الموقع حلاً مبسطًا للشركات لإضافة شات بوت إلى موقع الويب الخاص بهم، وعلى الفور، يمكنك الدردشة مع العملاء وحل مشاكلهم في الوقت الفعلي ، كما أنه يجعل من السهل تقديم امتيازات مثل الخصومات المخصصة بناءً على سجل التصفح، ويمكن للذكاء الاصطناعي أيضًا تقديم توصيات المنتج بناءً على سلوكهم</p>
            </div>
        </div>
        <div class="lg:w-1/2 w-11/12 h-max lg:h-64 border border-gray-300 rounded-lg p-4 m-4 bg-blue-900">
            <div class="lg:relative lg:top-1/8">
